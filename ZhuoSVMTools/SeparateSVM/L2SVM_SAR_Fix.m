function [ W,LOG ] = L2SVM_SAR_Fix( X,Y,W0,LL,LambdaList,Option )
...
for Iter=1:MaxIter
    ...
    if NeedCost==1
       Cost3=0;
       AfterProxiamlCostList(Iter,:)=[Cost1,Cost2,Cost3,Cost1+Cost2];
    end
    % gradient descent
    ...
    if NeedCost==1
        ...
        Cost3=0;
        BeforeProxiamlCostList(Iter,:)=[Cost1,Cost2,Cost3,Cost1+Cost2];
    end
