function [ W,LOG ] = L2SVM_Lasso_SAR_VaryStepSize( X,Y,W0,GroupIndListArray,GroupWeightList,LL,LambdaList,q,Option )
...
for Iter=1:MaxIter
    ...
    Threshold=LambdaList(3)*StepSize;
