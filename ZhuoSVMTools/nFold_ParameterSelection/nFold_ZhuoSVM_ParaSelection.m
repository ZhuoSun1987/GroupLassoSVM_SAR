function [ Result ] = nFold_ZhuoSVM_TrainingSet( X,Y,SAAOption,SparseOpt,FolderRoot,FolderName )
...
SavePath=fullfile(FolderRoot,FolderName,'Result.mat');
if ~exist(SavePath,'file')
    ...
    for j=1:FoldNum
        ...
        [PredScoreTest,PredLabelTest,PreScoreTrain,PredLabelTrian,AUCTest,ModifyAcc,W]...
            =LinearSVM_TrainTest(Xtrain,YTrain,Xtest,YTest,Lambda,SAAOption,SparseOpt);
