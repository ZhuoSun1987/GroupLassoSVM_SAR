function [PredScoreTest,PredLabelTest,PreScoreTrain,PredLabelTrian,AUCTest,ModifyAcc,W]=LinearSVM_TrainTest(TrainFeature,TrainYList,TestFeature,TestYList,Lambda,SAAOpt,SparseOpt0)
